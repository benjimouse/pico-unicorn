...
config['server'] = 'eb781d47892b46f194222fde7ef349c4.s2.eu.hivemq.cloud'  # Your MQTT Server
#  config['server'] = 'test.mosquitto.org'

config ['port'] = 8883 #Your MQTT Port
config['user'] ='XXXXX' #Your MQTT User Name
config ['password'] ='XXXXXX' # Your MQTT Password


config['ssid'] = 'XXXX' #Your Wifi SSID
config['wifi_pw'] = 'XXXXS' #Your Wifi Password
